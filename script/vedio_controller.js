angular.module('vedioCtrl', ['factories']).controller('indexCtrl', ['$rootScope', '$scope', '$timeout', 'http',
    function($rootScope, $scope, $timeout, http) {
        ...
        U.SkinDefault('web_module', 'webBrowser2018');
        ...
        var vm = $scope.vm = {},
            dUrl = ['./html/menu/' + localStorage.getItem('skin_index') + '.html', './html/menu/' + localStorage.getItem('skin_recommend') + '.html', './html/menu/' + localStorage.getItem('skin_user') + '.html'];
    ...
    function($rootScope, $scope, $timeout, http) {
        ...
        apiready = function() {
            ...
            api.addEventListener({
                ...
                alert(JSON.stringify(vm.keyword));
